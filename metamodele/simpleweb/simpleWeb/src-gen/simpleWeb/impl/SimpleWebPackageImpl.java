...
public class SimpleWebPackageImpl extends EPackageImpl implements SimpleWebPackage {
	 ...
	 * @generated
	 */
	public EAttribute getLienExterne_Url() {
		return (EAttribute) lienExterneEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(lienExterneEClass, LIEN_EXTERNE__URL);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getLienExterne_Siteweb(), this.getSiteWeb(), null, "siteweb", null, 0, 1, LienExterne.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLienExterne_Url(), ecorePackage.getEString(), "url", null, 0, 1, LienExterne.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
