 ...
 *   <li>{@link simpleWeb.impl.LienExterneImpl#getUrl <em>Url</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LienExterneImpl extends MinimalEObjectImpl.Container implements LienExterne {
	...
	public void setUrl(String newUrl) {
		...
		url = newUrl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleWebPackage.LIEN_EXTERNE__URL, oldUrl, url));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case SimpleWebPackage.LIEN_EXTERNE__URL:
			return getUrl();
		}
