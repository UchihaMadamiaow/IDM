 ...
 * </p>
 * <ul>
 *   <li>{@link simpleWeb.impl.PageImpl#getSection <em>Section</em>}</li>
 *   <li>{@link simpleWeb.impl.PageImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PageImpl extends MinimalEObjectImpl.Container implements Page {
	...
	protected EClass eStaticClass() {
		return SimpleWebPackage.Literals.PAGE;
	}
	...
	public EList<Section> getSection() {
		if (section == null) {
			section = new EObjectContainmentEList<Section>(Section.class, this, SimpleWebPackage.PAGE__SECTION);
		}
		return section;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleWebPackage.PAGE__NAME, oldName, name));
	}
