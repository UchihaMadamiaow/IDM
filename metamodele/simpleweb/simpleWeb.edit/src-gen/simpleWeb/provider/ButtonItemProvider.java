...
/**
 * This is the item provider adapter for a {@link simpleWeb.Button} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ButtonItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addParagraphePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Button_paragraphe_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Button_paragraphe_feature",
								"_UI_Button_type"),
						SimpleWebPackage.Literals.BUTTON__PARAGRAPHE, true, false, true, null, null, null));
	}
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						SimpleWebPackage.Literals.BUTTON__NAME, true, false, false,
	...
	protected void addPagePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Button_page_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Button_page_feature", "_UI_Button_type"),
						SimpleWebPackage.Literals.BUTTON__PAGE, true, false, true, null, null, null));
	}
