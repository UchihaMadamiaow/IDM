/**
 */
package org.eclipse.sirisus.sample.basicfamily.impl;
...
import org.eclipse.sirisus.sample.basicfamily.BasicfamilyPackage;
import org.eclipse.sirisus.sample.basicfamily.Man;
import org.eclipse.sirisus.sample.basicfamily.Person;
import org.eclipse.sirisus.sample.basicfamily.Woman;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirisus.sample.basicfamily.impl.PersonImpl#getParents <em>Parents</em>}</li>
 *   <li>{@link org.eclipse.sirisus.sample.basicfamily.impl.PersonImpl#getChildren <em>Children</em>}</li>
 *   <li>{@link org.eclipse.sirisus.sample.basicfamily.impl.PersonImpl#getFather <em>Father</em>}</li>
 *   <li>{@link org.eclipse.sirisus.sample.basicfamily.impl.PersonImpl#getMathor <em>Mathor</em>}</li>
 *   <li>{@link org.eclipse.sirisus.sample.basicfamily.impl.PersonImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PersonImpl extends MinimalEObjectImpl.Container implements Person {
	...
	/**
	 * The cached value of the '{@link #getMathor() <em>Mathor</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getMathor()
	 * @generated
	 ...
	 * @generated
	 */
	public Woman getMathor() {
		if (mathor != null && mathor.eIsProxy()) {
			InternalEObject oldMathor = (InternalEObject) mathor;
			mathor = (Woman) eResolveProxy(oldMathor);
			if (mathor != oldMathor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BasicfamilyPackage.PERSON__MATHOR,
							oldMathor, mathor));
			}
		}
		return mathor;
	 ...
	 * @generated
	 */
	public void setMathor(Woman newMathor) {
		Woman oldMathor = mathor;
		mathor = newMathor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasicfamilyPackage.PERSON__MATHOR, oldMathor,
					mathor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case BasicfamilyPackage.PERSON__MATHOR:
			if (resolve)
				return getMathor();
			return basicGetMathor();
