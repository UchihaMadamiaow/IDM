...
import org.eclipse.sirisus.sample.basicfamily.BasicfamilyFactory;
import org.eclipse.sirisus.sample.basicfamily.BasicfamilyPackage;
import org.eclipse.sirisus.sample.basicfamily.Family;
...
public class BasicfamilyPackageImpl extends EPackageImpl implements BasicfamilyPackage {
	 ...
	 * @see org.eclipse.sirisus.sample.basicfamily.BasicfamilyPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getPerson_Mathor() {
	...
	public void createPackageContents() {
		...
		createEReference(personEClass, PERSON__MATHOR);
	...
	public void initializePackageContents() {
		...
		initEReference(getPerson_Father(), this.getMan(), null, "father", null, 0, 1, Person.class, !IS_TRANSIENT,
				...
				IS_ORDERED);
		initEReference(getPerson_Mathor(), this.getWoman(), null, "mathor", null, 0, 1, Person.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
